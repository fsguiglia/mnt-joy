...
,
		...
		"boxes" : [ 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 835.0, 20.0, 30.0, 30.0 ]
				}
				...
				"box" : 				{
					...
					"saved_attribute_attributes" : 					{
						"valueof" : 						{
							...
							"parameter_longname" : "component_name[9]",
							"parameter_modmode" : 0,
...
, 			{
				"box" : 				{
					...
					"presentation" : 1,
					"presentation_rect" : [ 328.0, 1.5, 17.0, 16.0 ],
					"saved_attribute_attributes" : 					{
						"activebgcolor" : 						{
							"expression" : ""
						}
...
,
						...
						"boxes" : [ 							{
								"box" : 								{
									...
									"numoutlets" : 2,
									"outlettype" : [ "bang", "" ],
									"patching_rect" : [ 373.0, 312.0, 34.0, 22.0 ],
									"text" : "sel 0"
								}
...
, 							{
								"box" : 								{
									...
									"numoutlets" : 1,
									"outlettype" : [ "bang" ],
									"patching_rect" : [ 373.0, 357.0, 22.0, 22.0 ],
									"text" : "t b"
								}
...
, 							{
								"box" : 								{
									...
									"numoutlets" : 1,
									"outlettype" : [ "" ],
									"patching_rect" : [ 373.0, 399.0, 29.5, 22.0 ],
									"text" : "id 0"
								}
...
, 							{
								"box" : 								{
									...
									"numoutlets" : 1,
									"outlettype" : [ "" ],
									"patching_rect" : [ 285.0, 399.0, 67.0, 22.0 ],
									"text" : "prepend id"
								}
...
, 							{
								"box" : 								{
									...
									"numoutlets" : 1,
									"outlettype" : [ "int" ],
									"patching_rect" : [ 285.0, 361.0, 48.5, 22.0 ],
									"text" : "i 0"
								}
...
, 							{
								"box" : 								{
									...
									"patching_rect" : [ 179.0, 308.0, 125.0, 22.0 ],
									"text" : "t f b"
								}
...
, 							{
								"box" : 								{
									...
									"numoutlets" : 3,
									"outlettype" : [ "", "", "" ],
									"patching_rect" : [ 314.5, 121.0, 114.0, 22.0 ],
									"restore" : [ 0 ],
									"saved_attribute_attributes" : 									{
										"valueof" : 										{
											"parameter_invisible" : 1,
											"parameter_longname" : "component_id[9]",
...
, 							{
								"box" : 								{
									...
									"patching_rect" : [ 374.5, 80.0, 83.0, 22.0 ],
...
, 							{
								"box" : 								{
									...
									"numoutlets" : 1,
									"outlettype" : [ "" ],
									"patching_rect" : [ 179.0, 476.0, 125.0, 22.0 ],
									"saved_object_attributes" : 									{
										"_persistence" : 1,
										"normalized" : 0,
										"smoothing" : 5.0
...
, 							{
								"box" : 								{
									...
									"numoutlets" : 1,
									"outlettype" : [ "" ],
									"patching_rect" : [ 471.5, 40.0, 30.0, 30.0 ]
								}
...
, 							{
								"box" : 								{
									...
									"numoutlets" : 2,
									"outlettype" : [ "", "" ],
									"patching_rect" : [ 314.5, 80.0, 51.0, 22.0 ],
									"text" : "route id"
								}
...
, 							{
								"box" : 								{
									...
									"numoutlets" : 1,
									"outlettype" : [ "" ],
									"patching_rect" : [ 314.5, 40.0, 30.0, 30.0 ]
								}
						...
						"lines" : [ 							{
								"patchline" : 								{
									...
									"midpoints" : [ 324.0, 227.0, 382.5, 227.0 ],
									"order" : 0,
									"source" : [ "obj-1", 0 ]
								}
...
, 							{
								"patchline" : 								{
									...
									"midpoints" : [ 382.5, 448.0, 294.5, 448.0 ],
									"source" : [ "obj-18", 0 ]
								}
...
, 							{
								"patchline" : 								{
									"destination" : [ "obj-1", 0 ],
									"midpoints" : [ 384.0, 109.5, 324.0, 109.5 ],
									"source" : [ "obj-29", 0 ]
								}
...
, 							{
								"patchline" : 								{
									...
									"midpoints" : [ 188.5, 407.5, 188.5, 407.5 ],
									"source" : [ "obj-38", 0 ]
								}
...
, 							{
								"patchline" : 								{
									...
									"midpoints" : [ 481.0, 273.0, 188.5, 273.0 ],
									"source" : [ "obj-4", 0 ]
								}
...
,
					"patching_rect" : [ 366.5, 373.0, 491.5, 22.0 ],
					"saved_object_attributes" : 					{
						"description" : "",
						"digest" : "",
						"globalpatchername" : "",
...
, 			{
				"box" : 				{
					...
					"presentation" : 1,
					"presentation_rect" : [ 218.5, 1.0, 99.0, 17.0 ],
					"saved_attribute_attributes" : 					{
						"valueof" : 						{
							"parameter_enum" : [ "val1", "val2" ],
...
, 			{
		...
		"parameters" : 		{
			"obj-13" : [ "live.text[17]", "live.text", 0 ],
			"obj-16" : [ "component_name[9]", "component_name", 0 ],
			"obj-24" : [ "live.text[16]", "live.text[1]", 0 ],
			"obj-7::obj-1" : [ "component_id[9]", "component_id", 0 ],
			"parameterbanks" : 			{
